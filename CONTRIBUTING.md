Contributing to Cortex, an Open Anthem Project
==============================================

Summary
-------
This document covers how to contribute Open Anthem sponsored projects. 
_Lets get started!!!_
...
Using our demo project as an example: 

In your browser, navigate to: [https://github.com/openanthem/cortex](https://github.com/openanthem/cortex)

Fork the repository by clicking on the 'Fork' button on the top right hand side.  The fork will happen and you will be taken to your own fork of the repository.  Copy the Git repository URL by clicking on the clipboard next to the URL on the right hand side of the page under '**HTTPS** clone URL'.  You will paste this URL when doing the following `git clone` command.

On your computer, follow these steps to setup a local repository for working on Cortex:

``` bash
$ git clone https://github.com/YOUR_ACCOUNT/cortex.git
$ cd cortex
$ git remote add upstream https://github.com/openanthem/cortex.git
$ git checkout master
$ git fetch upstream
...
It is important that you maintain an up-to-date `master` branch in your local repository.  This is done by rebasing in the code changes from `upstream/master` (the official Cortex project repository) into your local repository.  You will want to do this before you start working on a feature as well as right before you submit your changes as a pull request.  I recommend you do this process periodically while you work to make sure you are working off the most recent project code.
...
Please include Issue id, detailed information about the bug/feature, what all tests are executed, how the reviewer can test this feature etc. Incase of UI PRs, a screenshot is preferred.
...
1. In your browser, navigate to your forked repository: [https://github.com/YOUR_ACCOUNT/cortex](https://github.com/YOUR_ACCOUNT/cortex)
...
5. Sign the Open Anthem Contributor Licensing Agreement, and place it on file; unless you've got one on file already.
...
Release Principles
------------------
Detailed information about Open Anthem Project release principles is available at https://anthemopensource.atlassian.net/wiki/display/OA/Release+Principals 
